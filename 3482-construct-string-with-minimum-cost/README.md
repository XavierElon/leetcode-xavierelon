<h2><a href="https://leetcode.com/problems/construct-string-with-minimum-cost">Construct String with Minimum Cost</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given a string <code>target</code>, an array of strings <code>words</code>, and an integer array <code>costs</code>, both arrays of the same length.</p>
